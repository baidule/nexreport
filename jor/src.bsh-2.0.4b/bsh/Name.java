...
class Name implements java.io.Serializable {
    ...
    */
    public Object toObject(CallStack callstack, Interpreter interpreter/*,int x, boolean ignoreValue*/)
        throws UtilEvalError {
        return toObject(callstack, interpreter, false/*, ignoreValue*/);
    }
    ...
    */
    synchronized public Object toObject(CallStack callstack, Interpreter interpreter,
        boolean forceClass/*, boolean ignoreValue*/) throws UtilEvalError {
        reset();
    ...
    */
    private Object consumeNextObjectField(CallStack callstack, Interpreter interpreter,
        boolean forceClass, boolean autoAllocateThis) throws UtilEvalError {
        /*
        ...
        */
        if (((evalBaseObject == null) && !isCompound(evalName)) && !forceClass) {
            Object obj = resolveThisFieldReference(callstack, namespace, interpreter, evalName,
                    false);
        ...
        */
        ...
        if (((evalBaseObject == null) || evalBaseObject instanceof This) && !forceClass) {
            ...
            if (evalBaseObject == null) {
                ...
                obj = resolveThisFieldReference(callstack, ((This) evalBaseObject).namespace,
            ...
            if (obj != Primitive.VOID) {
                ...
                if (Interpreter.DEBUG) {
                    Interpreter.debug("resolved variable: " + varName + " in namespace: " +
                        namespace);
                }
        ...
        */
        if (evalBaseObject == null) {
            ...
            */
            ...
            if (clas != null) {
                return completeRound(className, suffix(evalName, countParts(evalName) - i),
        ...
        if (((evalBaseObject == null) || evalBaseObject instanceof This) && !forceClass &&
                autoAllocateThis) {
            NameSpace targetNameSpace = (evalBaseObject == null) ? namespace
        ...
        */
        if (evalBaseObject == Primitive.NULL) { // previous round produced null
            throw new UtilTargetError(new NullPointerException("Null Pointer while evaluating: " +
                    value));
        }
        ...
        */
        if (evalBaseObject instanceof ClassIdentifier) {
            ...
            try {
                if (Interpreter.DEBUG) {
                    Interpreter.debug("Name call to getStaticFieldValue, class: " + clas +
                        ", field:" + field);
                }
        ...
        */
        ...
        try {
            ...
            if (evalBaseObject instanceof PropertyGetter) {
                obj = ((PropertyGetter) evalBaseObject).getProperty(field, callstack,
                        interpreter);

                if (obj == Primitive.VOID) {
                    obj = Reflect.getObjectFieldValue(evalBaseObject, field);
                }
            } else {
                obj = Reflect.getObjectFieldValue(evalBaseObject, field);
            }
    ...
    */
    Object resolveThisFieldReference(CallStack callstack, NameSpace thisNameSpace,
        Interpreter interpreter, String varName, boolean specialFieldsVisible)
        throws UtilEvalError {
    ...
    */
     ...
     */
    synchronized public LHS toLHS(CallStack callstack, Interpreter interpreter)
        throws UtilEvalError {
        ...
        try {
            while ((evalName != null) && isCompound(evalName)) {
                obj = consumeNextObjectField(callstack, interpreter, false /*forcclass*/,
                        true /*autoallocthis*/);
            }
        } catch (UtilEvalError e) {
        ...
        if (obj instanceof This) {
            ...
            if (evalName.equals("namespace") || evalName.equals("variables") ||
                    evalName.equals("methods") || evalName.equals("caller")) {
    ...
    */
    public Object invokeMethod(Interpreter interpreter, CallStack callstack,
        BSHMethodInvocation callerInfo)
        ...
        if (classOfStaticMethod != null) {
            return Reflect.invokeStaticMethod(bcm, classOfStaticMethod, methodName,
                callerInfo.getArgsNode().getArguments(callstack, interpreter));
        }

        if (!Name.isCompound(value)) {
            return invokeLocalMethod(interpreter, callstack, callerInfo);
        }
        ...
        if (!(obj instanceof ClassIdentifier)) {
            ...
            //            MethodInvoker invoker = MethodInvokerFactory.getInvoker(obj.getClass());
            //
            //            if (invoker != null) {
            //                return invoker.invoke(obj, methodName, interpreter, callstack, callerInfo);
            //            } else {
        ...
        if (clas != null) {
            return Reflect.invokeStaticMethod(bcm, clas, methodName,
                callerInfo.getArgsNode().getArguments(callstack, interpreter));
        }
    ...
    */
    private Object invokeLocalMethod(Interpreter interpreter, CallStack callstack,
        BSHMethodInvocation callerInfo)
        ...
        //        
        Object res = namespace.invokeLocalMethod(commandName, interpreter, callstack, callerInfo);
        ...
        if (commandObject == null) {
            ...
            if (invokeMethod != null) {
                return invokeMethod.invoke(new Object[] {
                        commandName,
                        args
            ...
            throw new EvalError("Command not found: " +
                StringUtil.methodString(commandName, argTypes), callerInfo, callstack);
        }
        ...
        if (commandObject instanceof Class) {
            try {
                return Reflect.invokeCompiledCommand(((Class) commandObject), args, interpreter,
                    callstack);
            } catch (UtilEvalError e) {
