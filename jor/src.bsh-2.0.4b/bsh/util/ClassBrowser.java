...
public class ClassBrowser extends JSplitPane implements ListSelectionListener, ClassPathListener {
    ...
    /**
     * Creates a new ClassBrowser object.
     */
    public ClassBrowser() {
    ...
    Constructor[] getPublicConstructors(Constructor[] constructors) {
        ...
        Constructor[] ca = (Constructor[]) v.toArray(new Constructor[0]);
    ...
    Field[] getPublicFields(Field[] fields) {
        ...
        return (Field[]) v.toArray(new Field[0]);
    }
     ...
     * DOCUMENT ME!
     *
     * @throws ClassPathException DOCUMENT ME!
     */
    public void init() throws ClassPathException {
        ...
        */
        ...
        JSplitPane sp = splitPane(JSplitPane.HORIZONTAL_SPLIT, true,
                labeledPane(new JScrollPane(classlist), "Classes"), rightPane);
        sp = splitPane(JSplitPane.HORIZONTAL_SPLIT, true,
        ...
        if (e.getSource() == classlist) {
            ...
            if (classname == null) {
                ...
                methodLineString = fullClassName + " (from " +
                    classPath.getClassSource(fullClassName) + ")";
            }
