...
public class Reflect {
    ...
    public static Object invokeObjectMethod(Object object, String methodName, Object[] args,
        ...
        //    	}
        // Bsh scripted object
    	if(object instanceof InterpreterAware)
    	{
    		((InterpreterAware)object).setInterpreter(interpreter);
    	}
        if (object instanceof This && !This.isExposedThisMethod(methodName)) {
            return ((This) object).invokeMethod(methodName, args, interpreter, callstack,
    ...
    public static Object invokeStaticMethod(BshClassManager bcm, Class clas, String methodName,
        Object[] args) throws ReflectError, UtilEvalError, InvocationTargetException {
    ...
    */
    static Object invokeMethod(Method method, Object object, Object[] args)
        ...
        try {
            ...
            throw new ReflectError("Cannot access method " +
                StringUtil.methodString(method.getName(), method.getParameterTypes()) + " in '" +
     ...
     * @return DOCUMENT ME!
     *
     * @throws ReflectError DOCUMENT ME!
    ...
    public static Object getIndex(Object array, int index)
        ...
        try {
            ...
            if (array instanceof List) {
                val = ((List) array).get(index);

                return Primitive.wrap(val);
            } else {
    ...
    */
    static LHS getLHSObjectField(Object object, String fieldName)
        ...
        if (object instanceof PropertySetter) {
            return new LHS((PropertySetter) object, fieldName);
        }
    ...
    private static Object getFieldValue(Class clas, Object object, String fieldName,
        boolean staticOnly) throws UtilEvalError, ReflectError {
        try {
    ...
    */
    protected static Method resolveExpectedJavaMethod(BshClassManager bcm, Class clas,
        Object object, String name, Object[] args, boolean staticOnly)
        throws ReflectError, UtilEvalError {
        if (object == Primitive.NULL) {
            throw new UtilTargetError(new NullPointerException("Attempt to invoke method " + name +
                    " on null value"));
        }
        ...
        if (method == null) {
            throw new ReflectError((staticOnly ? "Static method " : "Method ") +
                StringUtil.methodString(name, types) + " not found in class'" + clas.getName() +
                "'");
        }
    ...
    /**
        ...
        */
    protected static Method resolveJavaMethod(BshClassManager bcm, Class clas, String name,
        Class[] types, boolean staticOnly) throws UtilEvalError {
        if (clas == null) {
        ...
        if (method == null) {
            ...
            try {
                ...
                throw new UtilTargetError("Security Exception while searching methods of: " + clas,
                    e);
            }
     ...
     */
    private static Method findOverloadedMethod(Class baseClass, String methodName, Class[] types,
        boolean publicOnly) {
        if (Interpreter.DEBUG) {
            Interpreter.debug("Searching for method: " +
                StringUtil.methodString(methodName, types) + " in '" + baseClass.getName() + "'");
        }
    ...
    /**
            ...
            implements a public interface or derives from a public type.
             ...
             @see #gatherMethodsRecursive(
                    Class, String, int, boolean, java.util.ArrayList)
    */
    static Method[] getCandidateMethods(Class baseClass, String methodName, int numArgs,
        boolean publicOnly) {
        ArrayList candidates = gatherMethodsRecursive(baseClass, methodName, numArgs, publicOnly,
                null /*candidates*/);

        return (Method[]) candidates.toArray(new Method[0]);
    }
    ...
    */
    private static ArrayList gatherMethodsRecursive(Class baseClass, String methodName,
        int numArgs, boolean publicOnly, ArrayList candidates) {
        if (candidates == null) {
        ...
        if (publicOnly) {
            ...
            addCandidates(baseClass.getDeclaredMethods(), methodName, numArgs, publicOnly,
                candidates);
        }
    ...
    private static ArrayList addCandidates(Method[] methods, String methodName, int numArgs,
        boolean publicOnly, ArrayList candidates) {
    ...
    */
    static Object constructObject(Class clas, Object[] args)
        ...
        Constructor[] constructors = Capabilities.haveAccessibility()
    ...
    */
    static int findMostSpecificSignature(Class[] idealMatch, Class[][] candidates) {
        for (int round = Types.FIRST_ROUND_ASSIGNABLE; round <= Types.LAST_ROUND_ASSIGNABLE;
                round++) {
    ...
    private static String accessorName(String getorset, String propName) {
        return getorset + String.valueOf(Character.toUpperCase(propName.charAt(0))) +
    ...
    public static Object getObjectProperty(Object obj, String propName)
        ...
        try {
            ...
            method = resolveExpectedJavaMethod(null /*bcm*/, obj.getClass(), obj, accessorName,
                    args, false);
        } catch (Exception e) {
            e1 = e;
        }
    ...
    public static void setObjectProperty(Object obj, String propName, Object value)
        ...
        try {
            Method method = resolveExpectedJavaMethod(null /*bcm*/, obj.getClass(), obj,
    ...
    */
    ...
    /**
        ...
        */
    public static Class getArrayBaseType(Class arrayClass)
        throws ReflectError {
        if (!arrayClass.isArray()) {
    ...
    /**
            ...
            the result.
    */
    public static Object invokeCompiledCommand(Class commandClass, Object[] args,
        Interpreter interpreter, CallStack callstack) throws UtilEvalError {
    ...
    private static ReflectError cantFindConstructor(Class clas, Class[] types) {
        if (types.length == 0) {
            ...
            return new ReflectError("Can't find constructor: " +
                StringUtil.methodString(clas.getName(), types) + " in class: " + clas.getName());
        }
    }
