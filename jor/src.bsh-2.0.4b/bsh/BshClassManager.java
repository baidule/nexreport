...
public class BshClassManager {
    private static BshClassManager defaults;
    ...
    */
    public Class classForName(String name) {
        if (isClassBeingDefined(name)) {
            throw new InterpreterError("Attempting to load class in the process of being defined: " +
                name);
        }
    ...
    */
    protected Method getResolvedMethod(Class clas, String methodName, Class[] types,
        boolean onlyStatic) {
    ...
    */
    protected static Error noClassDefFound(String className, Error e) {
        return new NoClassDefFoundError("A class required by class: " + className +
            " could not be loaded:\n" + e.toString());
    }
