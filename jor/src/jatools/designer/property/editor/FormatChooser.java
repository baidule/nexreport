...
public class FormatChooser extends JDialog implements Chooser, ActionListener {
    ...
    static final String CUSTOM_CARD = "custom"; //
    ...
    static String[] patterns = new String[] {
            ...
            "#,##0.000", // //
            "#,##0.0000", // //
            null, App.messages.getString("res.334"), // //
    ...
    static Format2 CUSTOM_FORMAT = new Format2() {
            public String format(Object o) {
                return ""; //
            }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Format2[] formats = (Format2[]) ((JComponent) e.getSource()).getClientProperty(SELECTABLE);
    ...
    Format2[][] getFormats() {
        if (formats == null) {
            ...
            formats[j] = new Format2[] { CUSTOM_FORMAT };
        }
    ...
    private void buildUI() {
        patternSelector = new ListEditor(new Object[] { NULL_FORMAT },
                App.messages.getString("res.345"), true); //
        card = new CardLayout();
        ...
        preview.setBorder(BorderFactory.createTitledBorder(
                App.messages.getString("res.187"))); //
        patternSelector.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 0));
        patternSelector.addChangeListener(new ChangeListener() {
                public void stateChanged(ChangeEvent e) {
                    Format2 f = getSelectedFormat();
        ...
        Border border = BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(
                    10, 10, 10, 10), BorderFactory.createEtchedBorder());
    ...
    protected Format2 getSelectedFormat() {
        Format2 result = null;

        int i = patternSelector.getSelectedIndex();

        if (i != -1) {
            String text = patternSelector.getElementAt(i).toString();

            if (!text.equals(patternSelector.getSelectedValue())) {
                result = FormatUtil.getInstance((String) patternSelector.getSelectedValue());
            } else {
                result = (Format2) patternSelector.getElementAt(i);
            }
        }
    ...
    public Object getValue() {
        Object value = patternSelector.getElementAt(patternSelector.getSelectedIndex());
    ...
    public void setValue(Object value) {
        ...
        if (value != null) {
            formats[formats.length - 1][0] = (Format2) value;
        }
